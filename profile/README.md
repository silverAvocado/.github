...
- 데이터 전처리 / 음성 및 멀티모달 모델
  ...
  - [음성/멀티모달 모델](./models.png)
  - `silver-model-code`에 구현 
  - **`SilverAudio Model`**
    - [SilverAudio Model](./audio.png)
  - **`SilverMultimodal Model`**
    - [SilverMultimodal Model](./multimodal.png)
